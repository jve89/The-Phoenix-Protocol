module.exports = [
  {
    ...
    tone: "honest, grounded, compassionate",
...
### Topic: You Can’t Reconnect While Carrying Resentment

### Requirements:
- 500–650 words
- Explore how unspoken resentment quietly sabotages reconnection
- Guide a release process: “Write the letter you’ll never send”
- Provide emotional detox practices (movement, breath, journaling)
- End with: “Before you reopen the door, leave the old baggage outside.”

⚠️ SAFETY:
Avoid pushing forgiveness. Honour valid pain — offer slow release tools.
`
  },

  {
    format: "values scan",
    tone: "wise, calm, introspective",
    theme: "redefining partnership",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: What Kind of Relationship Are You Actually Asking For?

### Requirements:
- 550–700 words
- Unpack assumptions about “getting back together”
- Provide a values-based partnership scan: safety, respect, vision
- Offer journaling prompt: “What version of love feels *healthy* now?”
- End with: “You’re not asking to go back — you’re choosing what comes next.”

⚠️ SAFETY:
Do not assume the previous relationship structure was healthy. Encourage evolution.
`
  },

  {
    format: "attachment check-in",
    tone: "gentle, clinical-but-accessible, validating",
    theme: "attachment patterns",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Is It Longing — or Attachment Activation?

### Requirements:
- 500–650 words
- Describe how attachment wounds (esp. anxious/preoccupied) can mimic love
- Share a relatable case story of misread longing
- Provide a quick “secure vs activated” body cue list
- End with: “Love feels calm. Activation feels urgent. Know the difference.”

⚠️ SAFETY:
Avoid shame or diagnosis. Use gentle, explanatory language only.
`
  },

  {
    format: "self-honesty ritual",
    tone: "curious, vulnerable, warm",
    theme: "clarifying readiness",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.
...
### Requirements:
- 500–600 words
- Create a journaling sequence: “What am I truly craving today?”
- Invite reader to sit with loneliness without rushing into reconnection
- Offer somatic grounding and creative expression as emotional outlets
- End with: “Sometimes, the answer isn’t contact — it’s comfort.”

⚠️ SAFETY:
Normalise loneliness. Avoid invalidating desire, just separate urgency from clarity.
`
  },

  {
    format: "relational audit",
    tone: "reflective, strategic, self-respecting",
    theme: "pattern awareness",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Was This Just One Breakup — Or the Fifth Chapter of the Same Cycle?

### Requirements:
- 550–700 words
- Help the reader map any past breakup–reunion patterns
- Guide analysis of whether true change occurred in either party
- End with: “You’re not wrong to hope — just wise to notice the pattern.”

⚠️ SAFETY:
Don’t label patterns as toxic. Allow reader-led realisation.
`
  },

  {
    format: "forgiveness framework",
    tone: "strong, soft, liberating",
    theme: "healing ruptures",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: You Can’t Rebuild Over a Cracked Foundation

### Requirements:
- 500–650 words
- Explore the difference between surface forgiveness and deep repair
- Introduce the 3R model: Responsibility, Remorse, Repair
- End with: “Don’t ask if it’s possible — ask if it’s safe to try again.”

⚠️ SAFETY:
Never imply reader must forgive or forget. Emphasise mutual accountability.
`
  },

  {
    format: "boundary prep",
    tone: "firm, clear, empowering",
    theme: "self-protection during reconnection",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Set the Rules Before You Re-Enter the Game

### Requirements:
- 500–600 words
- Help reader define non-negotiables before reinitiating contact
- Offer a boundary worksheet: what they allow, expect, won’t tolerate
- End with: “It’s not control. It’s clarity.”

⚠️ SAFETY:
Do not make reader responsible for the ex’s behaviour. Keep the focus internal.
`
  },

  {
    format: "mental rehearsal",
    tone: "hopeful, pragmatic, reality-checking",
    theme: "visualising reconnection",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: What Happens If They Say Yes?

### Requirements:
- 500–650 words
- Guide reader through a future scenario: first call, meet-up, or message
- Explore emotional readiness for joy, awkwardness, or unmet needs
- End with: “You’re not just hoping — you’re preparing.”

⚠️ SAFETY:
Avoid fantasy spirals. Balance hope with real-world readiness.
`
  },

  {
    format: "support system check",
    tone: "wise, connected, emotionally mature",
    theme: "external anchors",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: You Can’t Reconnect Alone

### Requirements:
- 450–600 words
- Emphasise the importance of external clarity: friends, mentors, therapy
- Provide reflection: “What feedback have I been ignoring?”
- End with: “Love is yours to pursue — but wisdom is shared.”

⚠️ SAFETY:
Do not position friends as judges. Keep the support system affirming and stabilising.
`
  },

  {
    format: "emotional anchoring",
    tone: "anchored, steady, emotionally mature",
    theme: "handling mixed signals",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: What If They’re Giving You Hope — But No Clarity?

### Requirements:
- 500–650 words
- Help reader interpret “hot and cold” behaviour
- Provide response options: request clarity, step back, or disengage
- End with: “You don’t need perfect certainty — just enough to feel safe.”

⚠️ SAFETY:
Avoid shaming the ex. Support the reader’s right to stable communication.
`
  },

  {
    format: "emotional honesty",
    tone: "gentle, revealing, thoughtful",
    theme: "facing mixed feelings",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: You Want Them Back — But Do You Trust Them?

### Requirements:
- 500–650 words
- Help the user hold space for both desire and distrust
- Share a story of someone who paused reconnection due to unresolved trust gaps
- Include a trust self-check with three emotional barometers
- End with: “You can miss someone deeply — and still question if it’s safe to return.”

⚠️ SAFETY:
Do not promote blind optimism. Prioritise trust as a conscious, earned condition.
`
  },

  {
    format: "emotional boundary work",
    tone: "reassuring, clear, self-anchored",
    theme: "personal containment",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Love Them — Without Losing Yourself

### Requirements:
- 500–600 words
- Explain the difference between love and emotional fusion
- Include a visualization tool: “Your heart is a house — what’s private, what’s shared?”
- Offer a short self-boundary setting ritual
- End with: “You don’t have to shrink to make space for them.”

⚠️ SAFETY:
Avoid self-sacrifice narratives. Reinforce autonomy and emotional sovereignty.
`
  },

  {
    format: "relationship audit",
    tone: "curious, objective, grounded",
    theme: "compatibility review",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Were You Actually Compatible — Or Just Comfortable?

### Requirements:
- 500–650 words
- Explore the difference between emotional attachment and true alignment
- Share a story of someone who realised their ex met comfort but not growth
- Include a compatibility grid with 5 key areas (values, vision, habits, etc.)
- End with: “Comfort feels familiar — but alignment feels free.”

⚠️ SAFETY:
Don’t undermine emotional bonds. Offer insight without invalidating the past.
`
  },

  {
    format: "inner resilience",
    tone: "strong, nurturing, uplifting",
    theme: "emotional sovereignty",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Your Heart Doesn’t Need Permission to Heal

### Requirements:
- 500–650 words
- Reinforce that reconnection doesn’t require emotional approval from the other
- Use a metaphor like “your heart is a garden — you get to tend it regardless of visitors”
- Share a case of someone who thrived during a long pause
- End with: “Healing is your right — not a negotiation.”

⚠️ SAFETY:
Avoid revenge or overcompensation themes. Focus on authentic, quiet strength.
`
  },

  {
    format: "shared healing",
    tone: "balanced, generous, hopeful",
    theme: "co-growth",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Can You Grow Together — Not Just Apart?

### Requirements:
- 550–700 words
- Introduce the idea of parallel healing — two people evolving independently but alongside
- Share a real-world example of two exes who stayed in proximity without rushing
- Include journaling prompts: “What’s mine to grow? What’s theirs?”
- End with: “Some healing journeys stay separate. Some eventually walk side by side.”

⚠️ SAFETY:
Avoid implying the ex must evolve in sync. Honour both shared and solo timelines.
`
  },

  {
    format: "emotional recalibration",
    tone: "light, honest, grounded",
    theme: "reconnection energy shift",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: What If You’re Just Not the Same Anymore?

### Requirements:
- 500–600 words
- Explore how personal growth changes relational dynamics
- Include a comic metaphor (e.g. “your old favorite song now feels offbeat”)
- Share a story of someone who had to relearn their ex after time apart
- End with: “Growth changes the dance — and that’s not a bad thing.”

⚠️ SAFETY:
Avoid implying someone ‘outgrew’ the other. Encourage curiosity, not hierarchy.
`
  },

  {
    format: "truth-telling prep",
    tone: "brave, honest, emotionally literate",
    theme: "vulnerability and dialogue",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: What’s the One Thing You’re Afraid to Say?

### Requirements:
- 500–650 words
- Invite the reader to explore their deepest unsaid truth — with care
- Include a “safe expression” blueprint for vulnerable dialogue
- Share a short script on how to frame a raw feeling respectfully
- End with: “Your silence may be protecting you — but your truth can free you.”

⚠️ SAFETY:
Avoid pressuring confessions. Encourage pacing and self-validation.
`
  },

  {
    format: "realignment tool",
    tone: "clear, empowering, neutral",
    theme: "resetting expectations",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Pressing Reset — Without Repeating the Past

### Requirements:
- 500–650 words
- Introduce the idea of relational resets as conscious boundary work
- Provide a worksheet: “What we tried → What didn’t work → What we’ll do differently”
- Share a reconnection story built on new agreements
- End with: “History can teach you — but it doesn’t have to lead you.”

⚠️ SAFETY:
Avoid magical thinking or nostalgic loops. Prioritise active change.
`
  },

  {
    format: "expectation audit",
    tone: "wise, calming, practical",
    theme: "managing reconnection outcomes",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: Are You Hoping for a Version That Never Existed?

### Requirements:
- 500–650 words
- Gently question whether the reader is idealising their ex
- Offer a guided comparison exercise: “The real vs the remembered”
- Share a story of someone who found clarity by letting the fantasy dissolve
- End with: “You deserve love that’s real — not just remembered.”

⚠️ SAFETY:
Avoid demonising the ex. Honour past beauty while grounding in truth.
`
  },

  {
    format: "relationship closure loop",
    tone: "reflective, calm, decisive",
    theme: "letting go vs reconnecting",
    prompt: (gender, goalStage) => `
You are a breakup recovery coach writing a **premium guide for a user who wants to reconnect with their ex**.

### Topic: When Reconnection Becomes a Distraction from Closure

### Requirements:
- 500–650 words
- Explain how pursuit of reconnection can mask unfinished grief
- Offer a 3-step tool to distinguish true desire from avoidance
- Include a story of someone who let go to heal — and chose not to return
- End with: “Closure doesn’t always need a second chapter.”

⚠️ SAFETY:
Do not shame longing. Frame closure as personal sovereignty, not emotional defeat.
`
  },
